...
def entrantement_porte_ou(taille_des_donnees=200, test_size_percente=0.25, epoch =40, batch_size_ = 10, nombre_neuronne= 4, verbose= 0):
    """
    ...
    # Calculer les résultats de l'opération OU
    Output = A | B
    ...
    model.save('pages/PORTE_OU/or_gate_model.keras')
