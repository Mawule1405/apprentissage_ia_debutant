...
def entrantement_porte_ou( epoch =1000, batch_size_ = 4,  verbose= 1, progress_bar=None):
    """
    ...
    model.save('pages/PORTE_OU/or_gate_model_new.keras')
    
    valeurs = {"batch_size": batch_size_, "epoque":epoch, "verbose":verbose, "accuracy": accuracy, "loss": loss}
    chemin_du_fichier = "pages/PORTE_OU/parametres.json"
